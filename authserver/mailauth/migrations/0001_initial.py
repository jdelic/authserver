    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('required_permissions', models.ManyToManyField(blank=True, help_text='Permissions required for this application', related_name='application_set', related_query_name='application', to='auth.Permission', verbose_name='required permissions')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='mailauth_mnapplication', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
