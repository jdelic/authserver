...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('identifier', models.CharField(max_length=255, verbose_name='Permission identifier')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_permissions', models.ManyToManyField(blank=True, help_text='Permissions for OAuth2 applications', related_name='group_set', related_query_name='group', to='mailauth.MNApplicationPermission', verbose_name=' permissions')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='mnuser',
            name='groups',
            field=models.ManyToManyField(blank=True, related_name='user_set', related_query_name='user', to='mailauth.MNGroups', verbose_name='groups'),
        ),
        migrations.AddField(
            model_name='mnuser',
            name='user_permissions',
            field=models.ManyToManyField(blank=True, help_text='Permissions for OAuth2 applications', related_name='user_set', related_query_name='user', to='mailauth.MNApplicationPermission', verbose_name='user permissions'),
        ),
